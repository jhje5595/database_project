...
-- user1 계정을 암호 user1 으로 만듦.
DROP USER IF EXISTS 'user1'@'localhost';
create user user1@localhost identified by 'user1';

-- user1 권한 부여 맨 아래쪽에 존재
...
(4, 'RV004', 'DL4567890', 'CC004', '2025-05-10', 4, 720000, '2025-05-14', '텐트 포함', 40000),
(5, 'RV005', 'DL5678901', 'CC005', '2025-05-11', 3, 480000, '2025-05-14', '그릴 대여', 15000),
(6, 'RV006', 'DL6789012', 'CC006', '2025-05-13', 6, 570000, '2025-05-19', '침구 추가', 25000),
(7, 'RV007', 'DL7890123', 'CC007', '2025-05-14', 1, 200000, '2025-05-15', '세탁 서비스', 5000),
(8, 'RV008', 'DL8901234', 'CC008', '2025-05-15', 2, 260000, '2025-05-17', '포터블 스토브', 12000),
(9, 'RV009', 'DL9012345', 'CC009', '2025-05-16', 3, 525000, '2025-05-19', '멀티탭 대여', 5000),
(10, 'RV010', 'DL0123456', 'CC010', '2025-05-17', 7, 595000, '2025-05-24', '랜턴 추가', 8000),
(11, 'RV011', 'DL1123456', 'CC011', '2025-05-18', 4, 560000, '2025-05-22', '캠핑의자 대여', 10000),
(12, 'RV012', 'DL2123456', 'CC012', '2025-05-19', 2, 310000, '2025-05-21', '전기히터', 15000);
...
('SR003', 'RV003', 'P003', '2024-04-22', 60, 'E002'),
('SR004', 'RV004', 'P004', '2024-04-25', 75, 'E003'),
('SR005', 'RV005', 'P005', '2024-04-28', 80, 'E004'),
('SR006', 'RV006', 'P006', '2024-05-01', 95, 'E005'),
('SR007', 'RV007', 'P007', '2024-05-03', 100, 'E006'),
('SR008', 'RV008', 'P008', '2024-05-05', 110, 'E007'),
('SR009', 'RV009', 'P009', '2024-05-07', 70, 'E008'),
('SR010', 'RV010', 'P010', '2024-05-09', 85, 'E009'),
('SR011', 'RV011', 'P011', '2024-05-11', 90, 'E010'),
('SR012', 'RV012', 'P012', '2024-05-13', 105, 'E011');
...
(5, 'RV005', 'CC005', 'RS005', 'DL5678901', '에어컨 점검', '2024-05-05', 100000, '2024-05-10', '냉매 충전 포함'),
...
(11, 'RV011', 'CC011', 'RS011', 'DL1123456', '서스펜션 수리', '2024-05-17', 300000, '2024-05-22', '쇼바 포함'),
(12, 'RV012', 'CC012', 'RS012', 'DL2123456', '기어 점검', '2024-05-19', 160000, '2024-05-24', '미션오일 포함');



GRANT SELECT, INSERT, UPDATE, DELETE ON `DBTEST`.`캠핑카` TO 'user1'@'localhost'; -- 캠핑카 대여에 필요
GRANT SELECT, INSERT, UPDATE, DELETE ON `DBTEST`.`캠핑카대여` TO 'user1'@'localhost'; -- 캠핑카 대여에 필요
GRANT SELECT ON `DBTEST`.`캠핑카대여회사` TO 'user1'@'localhost'; -- 캠핑카 대여에 필요
GRANT SELECT ON `DBTEST`.`고객` TO 'user1'@'localhost'; -- 로그인시 아이디,비밀번호 대조 필요
GRANT SELECT, INSERT, UPDATE ON `DBTEST`.`외부정비정보` TO 'user1'@'localhost'; -- 대여한 캠핑카에 대해 외부정비를 의뢰해야함
GRANT SELECT ON `DBTEST`.`외부캠핑카정비소` TO 'user1'@'localhost';     -- 현재 등록되어 있는 정비소 목록을 확인해야함
